...
import {User, UserDocument, UserModelType, userSchema} from "../../../src/features/users/domain/user.entity";
...
describe(`<<AUTH>> ENDPOINTS TESTING!!!`, ()=>{
    ...
    const recoveryRegCode = RandomCodeServices.genRandomCode();
    const resendRegCode = RandomCodeServices.genRandomCode();
    const newRegCode = RandomCodeServices.genRandomCode();
...
8
    ...
    describe(`POST -> "/auth/registration"`, ()=>{
        ...
        it(`POST -> "/auth/registration": Everything ok. STATUS 204;`, async () => {
            console.log(recoveryRegCode)
            mockSetCodeDateRegConfirm(recoveryRegCode)
    ...
    describe(`POST -> "/auth/registration-email-resending"`, ()=>{
        ...
        it(`POST -> "/auth/registration-email-resending": Everything ok. STATUS 204;`, async () => {
            mockSetCodeDateRegConfirm(resendRegCode)
    ...
    describe(`POST -> "/auth/registration-confirmation"`, ()=>{
        ...
        it(`POST -> "/auth/registration-confirmation": Not valid registration Data. STATUS 400;`, async () => {
            ...
            mockSetCodeDateRegConfirm(newRegCode, new Date())
            spyRateLimit.mockReturnValue(false)
            await createUserByReg(app,userDtos[2]);
            mockSetCodeDateRegConfirm()
